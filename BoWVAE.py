...
from torch.nn.functional import log_softmax, sigmoid, softmax

#
#   Code from https://github.com/nxii/Dialog-Response-Generation
#
class BoWVAE(nn.Module):
    
    def __init__(self, hidden_size, latent_size, vocab_size, temperature, device='cpu'):
        super().__init__()
        self.device = device
